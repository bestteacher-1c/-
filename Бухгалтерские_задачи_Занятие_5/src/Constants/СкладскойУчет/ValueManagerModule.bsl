	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ВыборкаДетальныеЗаписи.Значение <> ДополнительныеСвойства.ЗначениеДо Тогда
			...
			Пока Выборка.Следующий() Цикл
				...
				ДанныеСчета = ОбщийМодульНаСервереВызовСКлиента.ПолучитьСвойствоСчета(Выборка.Ссылка);
				...
				Иначе
				//Удалить
					СтрокаДляУдаления = ПСОбъект.ВидыСубконто.Найти(ПланыВидовХарактеристик.ВидыСубконто.Склады, "ВидСубконто");
