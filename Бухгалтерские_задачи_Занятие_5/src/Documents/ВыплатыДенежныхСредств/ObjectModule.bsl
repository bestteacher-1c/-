...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Серверный.ЗаполнитьСубконтоСтороныПроводки(Движение,1,КорСубконто1,"Дт");
	Серверный.ЗаполнитьСубконтоСтороныПроводки(Движение,2,КорСубконто2,"Дт");
	...
	Серверный.ЗаполнитьСубконтоСтороныПроводки(Движение,"ДвиженияДенежныхСредств",ДДС,"Кт");
	
	Серверный.СформироватьПроводкиКурсовыеРазницы(Движение, Движения.Проводки, "Дт");
	Серверный.СформироватьПроводкиКурсовыеРазницы(Движение, Движения.Проводки, "Кт");
