...
Процедура ПродажаТовара(Отказ, Режим)
	...
	//--ПРОВЕРКА НАЛИЧИЯ УЧТЕННОГО ТМЦ ПО СЧЕТУ НА СКЛАДЕ
		...
		//=========================================================================
			...
			Бухгалтерия.ЗаполнитьКоличествоСтороныПроводки(Движение, ВыборкаДетальныеЗаписи.Количество, "Кт");

			Бухгалтерия.ЗаполнитьСубконтоСтороныПроводки(Движение, "Номенклатура", ВыборкаДетальныеЗаписи.Номенклатура, "Кт");
			...
			Бухгалтерия.ЗаполнитьВалютуСтороныПроводки(Движение, Валюта, ВыборкаДетальныеЗаписи.Сумма, "Дт");
