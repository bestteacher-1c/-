...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Движение.Сумма = БухгалтерияВызовСервера.ПересчитатьИзВалютыВВалюту(Валюта,Неопределено ,Сумма ,Дата );
	...
	Бухгалтерия.ЗаполнитьСубконтоСтороныПроводки(Движение,"ДвиженияДенежныхСредств",ДвижениеДенежныхСредств,"Кт");
