...
// ПриИзмененииРасчетовПоДоговорам()
&НаСервере
...
Процедура ОбработатьСубконтоДДС()
	...
	//Находим все счета подчиненные счетам учёта денежных средств.
		//Их может добавить пользователь
		//Условие запроса В ИЕРАРХИИ найдет и сами счета КАССА и СЧЕТВБАНКЕ
